...
.. sourcecode:: console
    ...
    mkdir openremfiles
    pip download -d openremfiles openrem==0.9.0b4
...
.. note::
    ...
    ``pip install -d openremfiles openrem==0.9.0b4``
...
.. sourcecode:: python
    ...
    pip install --no-index --find-links=openremfiles openrem==0.9.0b4  # where openremfiles is the directory you created
