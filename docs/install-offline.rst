...
.. note::
    ...
    ``pip install -d openremfiles openrem==0.9.0b5``
...
.. sourcecode:: python
    ...
    pip install --no-index --find-links=openremfiles openrem==0.9.0b5  # where openremfiles is the directory you created
