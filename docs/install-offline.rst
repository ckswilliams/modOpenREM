...
.. sourcecode:: console
    ...
    mkdir openremfiles
    pip download -d openremfiles openrem==0.9.0b1
...
.. note::
    ...
    ``pip install -d openremfiles openrem==0.9.0b1``
...
.. sourcecode:: python
    ...
    pip install --no-index --find-links=openremfiles openrem==0.9.0b1  # where openremfiles is the directory you created
