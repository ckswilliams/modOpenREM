...
.. code-block:: console
    ...
    pip download -d openremfiles openrem==0.9.1b1
...
.. code-block:: python
    ...
    pip install --no-index --find-links=openremfiles openrem==0.9.1b1  # where openremfiles is the directory you created
