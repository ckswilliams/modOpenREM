...
.. sourcecode:: console
    ...
    pip download -d openremfiles openrem==0.9.0b6
...
.. note::
    ...
    ``pip install -d openremfiles openrem==0.9.0b6``
...
.. sourcecode:: python
    ...
    pip install --no-index --find-links=openremfiles openrem==0.9.0b6  # where openremfiles is the directory you created
