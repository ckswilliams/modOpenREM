...
0.8.0 (?)
---------
* `#446`_  Import: Extract some Philips private information for Allura Xper systems, create workaround for missing end angles for rotational acquisitions* `#566`_  Interface: Correctly show "assumed patient mass" in case of set value of zero
