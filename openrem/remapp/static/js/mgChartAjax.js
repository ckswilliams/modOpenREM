    ...
    $.ajax({
        ...
        success: function( json ) {
            ...
            if(typeof plotMGAGDvsThickness !== 'undefined') {
                updateScatterChart(json.AGDvsThickness, json.maxThicknessAndAGD, 'scatterDIV1', json.AGDvsThicknessSystems, colour_scale);
            }

            // kVp vs compressed thickness scatter plot
            if(typeof plotMGkVpvsThickness !== 'undefined') {
                updateScatterChart(json.kVpvsThickness, json.maxThicknessAndkVp, 'scatterDIV2', json.kVpvsThicknessSystems, colour_scale);
            }

            // mAs vs compressed thickness scatter plot
            if(typeof plotMGmAsvsThickness !== 'undefined') {
                updateScatterChart(json.mAsvsThickness, json.maxThicknessAndmAs, 'scatterDIV3', json.mAsvsThicknessSystems, colour_scale);
            }
