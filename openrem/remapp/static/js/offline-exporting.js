    ...
    c.Chart.prototype.exportChartLocal = function (z, A) {
        var i = this, b = c.merge(i.options.exporting, z), B = g.userAgent.indexOf("WebKit") > -1 && g.userAgent.indexOf("Chrome") < 0, n = b.scale || 2, p, s = e.URL || e.webkitURL || e,
            k, t = 0, q, o, u, d = function () {
                ...
                try {
                    if (!B && g.userAgent.toLowerCase().indexOf("firefox") < 0)return s.createObjectURL(new e.Blob([a], {type: "image/svg+xml;charset-utf-16"}))
                } catch (b) {
                }
                ...
                if (g.msSaveOrOpenBlob)g.msSaveOrOpenBlob(a,
                    d); else if (f.download !== void 0)f.href = a, f.download = d, f.target = "_blank", l.body.appendChild(f), f.click(), l.body.removeChild(f); else try {
        ...
        try {
            k.length || x();
            for (o = 0, u = k.length; o < u; ++o)q = k[o], v(q.getAttributeNS("http://www.w3.org/1999/xlink", "href"), {imageElement: q}, C, d, d, d)
        } catch (D) {
            d()
        }
    };
