$(function () {
    ...
    var chartStudyDLP = new Highcharts.Chart({
        ...
        series: [{
            useHTML: true,
            name: 'Median DLP',
            data: $.extend(true, [], studySeriesMedianData)
        }],
        drilldown: {
    ...
    switch(chartSorting) {
        case 'freq':
            ...
            break;
        case 'dlp':
            seriesSort('#histogramStudyPlotDIV', studySeriesMedianData, 'y', chartSortingDirection);
            break;
        case 'name':
            seriesSort('#histogramStudyPlotDIV', studySeriesMedianData, 'name', chartSortingDirection);
            break;
        default:
