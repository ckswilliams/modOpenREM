...
from remapp.views import PatientIDSettingsUpdate, DicomDeleteSettingsUpdate, SkinDoseMapCalcSettingsUpdate, HomePageAdminSettingsUpdate
...
urlpatterns = patterns('remapp.views',
        ...
        'mg_summary_chart_data', name='mg_summary_chart_data'),
                       ...
                       url(r'^admin/review/failed/(?P<modality>\w+)/$', 'review_failed_imports', name='review_failed_imports'),
                       url(r'^admin/review/failed/study$', 'review_failed_study_details', name='review_failed_study_details'),
                       url(r'^admin/review/studiesdeletefailed$', 'review_failed_studies_delete', name='review_failed_studies_delete'),
