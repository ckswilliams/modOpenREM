...
urlpatterns = patterns('remapp.views',
    ...
    url(r'^admin/ot/(?P<equip_name_pk>\d+)/$', 'ot_summary_list_filter', name='ot_summary_list_filter'),
    url(r'^admin/equipmentcount$', 'display_names_count', name='display_names_count'),
