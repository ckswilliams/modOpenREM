...
def qrscu(
    ...
    Args:
      ...
      single_date(str, optional): Date to search on, format yyyy-mm-dd (Default valie = None)
      time_from(str, optional): Time of day to search from, format hhmm 24 hour clock (Default value = None)
      time_until(str, optional): Time of day to search until, format hhmm 24 hour clock (Default value = None)
