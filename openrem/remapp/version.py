__version__ = "0.8.1b2"                 # Actual version number
__docs_version__ = "0.8.1b2"            # Should match the tag readthedocs will build against
...
__repo_branch__ = "0.8.1b2"     # __repo_branch__feeds into construction of link in netdicom-orthanc-config doc
