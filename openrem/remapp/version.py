__version__ = "0.9.0b6"                   # Actual version number
__docs_version__ = "0.9.0b6-docs"              # Should match the branch readthedocs will build against - tag + '-docs'
...
__repo_branch__ = "0.9.0b6"               # __repo_branch__feeds into construction of link in netdicom-orthanc-config doc
