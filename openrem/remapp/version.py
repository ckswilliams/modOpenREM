__version__ = "0.9.0b2"                   # Actual version number
__docs_version__ = "0.9.0b2"              # Should match the tag readthedocs will build against
...
__repo_branch__ = "0.9.0b2"               # __repo_branch__feeds into construction of link in netdicom-orthanc-config doc
