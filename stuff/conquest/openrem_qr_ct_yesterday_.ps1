# Script to obtain all CT studies from PACS for the date prior to the script is
...
python D:\Server_Apps\python27\Scripts\openrem_qr.py 1 1 -ct -f $dateString -t $dateString